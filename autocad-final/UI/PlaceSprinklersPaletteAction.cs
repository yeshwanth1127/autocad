...
{
    /// <summary>Palette entry for <c>PLACESPRINKLERS</c> (modeless UI must queue the command).</summary>
    public static class PlaceSprinklersPaletteAction
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                new PlaceSprinklersCommand().PlaceSprinklers();
            }
            catch (Exception ex)
            {
